<%-- 
    Document   : index
    Created on : Dec 3, 2018, 3:49:07 PM
    Author     : Vipusayini.P
--%>
...
<html>
    ...
    <body>
        ...
        <br>
              ...
              <p><b>
                order your choices </b> <a href="order.jsp">Click Here...</a>
            ...
            <div id="adbox">
                ...
                <%
                    if(session.getAttribute("uid") != null){
                        ...
                        out.println("<h3>Hi!!!  welcome to our Garment..... Now Your Turn To select Your Choices...</h3>");
                    } else {
