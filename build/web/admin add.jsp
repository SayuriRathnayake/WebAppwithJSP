<%-- 
    Document   : admin add
    Created on : Dec 1, 2018, 7:33:31 PM
    Author     : Vipusayini.P
--%>
...
<html>
    ...
    <body>
                ...
                <div id="logo">
                     <a href="index_toberemoved.html"><span>Our Garment</span></a>
                </div>
                 <div class="row">
            <div class="col-sm-3" >
                <h1>Smart Shirts</h1>
       ...
       <div id="contents">
            <div id="adbox">
                <img src="images/addadmin.png" alt="Img">
                
                <h1>Added Admin details</h1>
                ...
                <%
                    ...
                    try {
                        ...
                        String query = "INSERT INTO admin_details (firstname,lastname,gender,nicno,address,username,password) VALUES ('"+firstname+"', '"+lastname+"', '"+gender+"', '"+nicno+"', '"+address+"', '"+username+"', '"+password+"')";
                        int n = stmt.executeUpdate(query);
                        if (n!=0){
                            out.println("<h4>Registration Successfull... Now you can login to <a href='profile.html'>Our Garments</a></h4>");
                        }else{
                            out.println("<h4>Error while registering the admin.</h4>");
                        }
