    ...
    if (fname1 != null && lname1 != null && phone1 != null) {
        if (fname1 != "" && lname1 != "" && phone1 != "") {
            ...
            try {
                ...
                connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/garment", "root", "");
                String queryString = "insert into contact(fname,lname,email,phone,message) values(?,?,?,?,?)";
